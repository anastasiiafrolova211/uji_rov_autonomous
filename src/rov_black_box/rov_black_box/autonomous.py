...
class BlueROVVisionNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(
            f'Vision Control Ready. Mode: Deadband Squaring + INSTANT LUNGE'
        )
        ...
        try:
            ...
            if self.mission_state == "DIVING":
                ...
                if area_error > self.area_deadband:
                    ...
                    backoff = min(self.max_backoff_speed,
            ...
            if active_target:
                ...
                if handle_target:
                    ...
                    cv2.putText(frame, "HANDLE", (hx+10, hy), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 255), 1)
                ...
                if not can_move_forward and self.mission_state == "APPROACHING":
                    cv2.putText(frame, "HALTED: SQUARING UP", (20, 190), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                if self.is_squared and self.mission_state == "APPROACHING":
                     cv2.putText(frame, "LOCKED: HANDLE TARGETING", (20, 190), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
